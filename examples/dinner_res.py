...
def run_agent_action(user_prompt, auto_mode=True, input_callback=None):
    ...
    My phone number is 916-708-4532. I do not want to sign up for dining offers and news from this restaurant.

    Yes i do want text updates and reminders about my reservation
